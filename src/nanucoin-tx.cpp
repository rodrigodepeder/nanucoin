...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nanucoin Core nanucoinx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nanucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nanucoin transaction") + "\n" +
                               "  nanucoin-tx [options] -create [commands]   " + _("Create hex-encoded nanucoin transaction") + "\n" +
                               "\n";
